...
class yolo_reid():
    def __init__(self, cfg, args, path):
        ...
        self.out = cv2.VideoWriter('vidpoutreid.mp4', cv2.VideoWriter_fourcc(*"mp4v"), 20, (width, height))
...
def parse_args():
    ...
    parser.add_argument("--video_path", default='../yolov8peoplecounter/vidp.mp4', type=str)
